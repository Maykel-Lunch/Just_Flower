...
<body class="bg-gray-100 min-h-screen" x-data="{ isLoading: false }" x-init="$watch('isLoading', value => { if (value) document.body.classList.add('overflow-hidden'); else document.body.classList.remove('overflow-hidden'); })">
    
    <!-- Loading Animation : Edit this based on your preferred animation-->
    <div x-show="isLoading" x-cloak class="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center z-50">
    ...
    @include('partials.faq') <!-- Include the FAQ section -->
